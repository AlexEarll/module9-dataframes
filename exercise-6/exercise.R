...
husky.games.2015 <- read.csv("C:/Users/aearl/Documents/Info 201/Module Practice/module9-dataframes/exercise-6/data/huskies_2015.csv", stringsAsFactors=FALSE)
...
max.score <- max(husky.games.2015[['combined']])
print(max.score)
print(max.score)
...
MostYardScore <- function(your.frame) {
  return (paste(""))
}
